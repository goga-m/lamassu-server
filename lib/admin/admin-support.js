...
const options = {
  keyPath: '/root/lamassu-support/SERVER_KEY.key',
  certPath: '/root/lamassu-support/SERVER_CERT.pem',
  ca: '/root/lamassu-support/CA_CERT.pem'
}
...
webServer.listen(443, () => {
  console.log('lamassu-support-server listening on port 443')
})
